            ...
            <div className="w-[408px] h-[661px] py-[16px]">
                <div className="flex items-center justify-center">
                    <label className="w-[519px] cursor-pointer agreement flex items-center">
                        ...
                        <p className="ml-[8px] text-[15px] font-bold">프로젝트 문서 불러오기</p>
                    </label>
                ...
                <p className="mt-[11px] text-[#C0473C] text-[13px]">* 필수 작성 항목입니다.</p>
                <p className="mt-[14px] text-[#52525B] font-bold">프로젝트<span className="text-[#C0473C]">*</span></p>
                <p className="mt-[2px] flex items-center text-[#EF8888] text-[14.5px] font-bold">⚠ 프로젝트를 선택하세요</p>
                <select className="appearance-none w-full h-[48px] mt-[6px] px-[10px] py-[8px] border-[2px] border-[#EF8888] rounded-[12px] text-[#9A9AA3]">
                ...
                <p className="mt-[12px] text-[#C0C0C0] text-[14px]">프로젝트를 먼저 선택하면 문서 목록이 나타납니다.</p>
                ...
                <ChevronDown
                    ...
                    size={18}
                />
                <p className="mt-[28px] text-[#52525B] font-bold">입력방식<span className="text-[#C0473C]">*</span></p>
                <div className="w-full h-[44px] flex items-center border-[2px] border-[#E4E4E7] rounded-[8px] mt-[14px]">
