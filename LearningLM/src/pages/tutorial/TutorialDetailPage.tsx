...
const blockColorClassMap: Record<
  TutorialBlock['color'],
  string
> = {
  blue: 'bg-blue-500',
...
const flowLabelClassMap: Record<
  TutorialBlock['color'],
  string
> = {
...
export function TutorialDetailPage() {
  ...
  const handleStartTutorial = () => {
    navigate(
      `/studio?tutorialId=${tutorial.id}&mode=guided`,
      {
        state: {
  ...
  const handleOpenSavedTutorials = () => {
    navigate('/my-storage?tab=saved')
  }
