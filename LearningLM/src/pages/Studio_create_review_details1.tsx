        ...
        <>
            ...
            <div className="h-[62px] pl-[27px] pr-[9.4px] bg-white flex items-center justify-between text-[#27272A]">
                ...
                <div className="ml-[27px] flex flex-1 items-center gap-[18px]">
                    ...
                    <div className="flex items-center gap-[9px]">
                        ...
                        text-[#9A9AA3] text-[13px] font-bold">3</p>
            ...
            <main className="min-h-screen pb-[60px] flex justify-center bg-[#F5F5F7] border-t-[1.5px] border-[#E4E4E7]">
                <div className="w-[1158px]  flex flex-col min-h-screen text-[#27272A]">
                    <p className="mt-[30px] text-[#9A9AA3] text-[15px] font-bold">2 / 3 · 공개 설정</p>
                    <p className="text-[38.5px] font-bold">워크플로우 정보를 입력하세요</p>
                    <div className="flex itesm-center mt-[38px] gap-[15px]">
                        <p className="w-[26px] h-[26px] flex items-center justify-center bg-[#6366F1] rounded-[50px] 
                    ...
                    <div className="w-[1158px] h-[364px] mt-[42px] pt-[24px] pl-[28px] bg-white gap-[23.8px] border-[1.5px] border-[#E4E4E7] rounded-[12px]">
                        ...
                        <div className="mt-[10px] flex items-center">
                            <div className="w-[216px] flex flex-col gap-[9px]">
                                <button className="h-[140px] flex items-center justify-center border-[1.5px] border-[#E4E4E7] rounded-[12px]
                                text-[#9A9AA3] text-[15px]">썸네일</button>
                                <p className="cursor-pointer hover:text-white hover:bg-[#6366F1] h-[44px] flex items-center justify-center border-[1.5px] border-[#E4E4E7] rounded-[12px]
                                text-[16.5px] font-bold">이미지 변경</p>
                            </div>
                    ...
                    <div className="w-full h-[380px] mt-[23px] px-[28px] pt-[24px] bg-white border-[1.5px] border-[#E4E4E7] rounded-[12px]">
                        ...
                        <div className="mt-[10px] flex items-center gap-[12px] text-[#52525B] text-[17px] font-bold">
                            <p className="w-[95.2px] h-[37px] flex items-center justify-center bg-[#F0F0F3] border-[1.5px] border-[#E4E4E7] rounded-[50px]
                            ">자료조사</p>
                            <p className="w-[99.5px] h-[37px] flex items-center justify-center bg-[#F0F0F3] border-[1.5px] border-[#E4E4E7] rounded-[50px]
                            ">문서 요약</p>
                            <p className="w-[78px] h-[37px] flex items-center justify-center bg-[#F0F0F3] border-[1.5px] border-[#E4E4E7] rounded-[50px]
                            ">글쓰기</p>
                            <p className="w-[133.4px] h-[37px] flex items-center justify-center bg-[#F0F0F3] border-[1.5px] border-[#E4E4E7] rounded-[50px]
                            ">반복 작업 정리</p>
                            <p className="w-[133.4px] flex items-center justify-center text-[#6366F1] text-[18px] font-bold">결과물 검토</p>
                            <p className="w-[105.4px] h-[37px] flex items-center justify-center bg-[#F0F0F3] border-[1.5px] border-[#E4E4E7] rounded-[50px]
                            ">AI 툴 활용</p>
                        </div>
                        <div className="flex text-[#52525B] font-bold">
                            ...
                            <div className="w-[871px] mt-[15.5px] ml-[24.8px]">
                                ...
                                <div className="w-full h-[54px] mt-[12px] pl-[26.2px] flex items-center gap-[34.6px] border-[1.5px] border-[#E4E4E7] rounded-[10px]
                                text-[16.5px] text-[#6366F1]">
                                    ...
                                    <p className="cursor-pointer text-[#9A9AA3] text-[17px] font-normal">태그 추가</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-[20px] flex items-center justify-between">
                        ...
                        <div className="w-[567px] h-[190px] px-[30px] bg-white flex flex-col pt-[27px] pl-[24px] gap-[14px] border-[1.5px] border-[#E4E4E7] rounded-[12px]">
                            <div className="w-full mt-[-5px] flex items-center justify-between ">
                                ...
                                <img src={temp_dashed} className="absolute w-[117px] h-[32px] ml-[390px]" />
                                <p className="w-[117.2px] h-[32px] flex items-center justify-center
            ...
            <footer className="h-[82px] pl-[52px] pr-[28px] bg-white flex items-center">
                <p className="text-[#52525B] text-[18.5px] font-bold"
                    onClick={() => {
