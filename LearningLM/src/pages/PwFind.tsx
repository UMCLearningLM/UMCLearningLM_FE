            ...
            <div className="min-h-screen flex flex-col items-center bg-[#F5F5F7] text-[#464646] text-[18px] py-[100px]">
                ...
                <div className="bg-white w-[600px] min-h-[531px] flex flex-col items-center px-[10px] py-[50px] rounded-[12px]">
                    ...
                    <div className="flex flex-col w-[529px]">
                        ...
                        <p className="text-[#52525B] mt-[7px]">이메일을 입력해주세요.</p>
                    </div>
                    {/*main content */}
                    {/*email */}
                    ...
                    <div>
                        <p className="text-[#52525B] mt-[71px]">계정이 없으신가요? {" "}
                            <button onClick={() => { navigate("/") }}>
                                <span className="cursor-pointer text-[#6366F1] font-bold mt-[20px]">회원가입</span>
                            </button>
                        </p>
                        <p className="text-[#52525B] mt-[14px]">이미 계정이 있으신가요? <span className="text-[#6366F1] font-bold mt-[20px]">로그인</span></p>
                    </div>
                </div>
                {/*white box 끝 */}
